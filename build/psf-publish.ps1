...
if ($LocalRepo) {
	Write-Host "Creating Nuget Package for module: 'Banxico.CLABE' at '$(Get-Location)"
	Publish-PSFModule -Path "$($publishDir)\Banxico.CLABE" -DestinationPath . -SkipDependenciesCheck
	return
}
