...
Param (
	...
	[string[]]
	$CommandPath = @("$global:testroot\..\Banxico.CLABE\functions", "$global:testroot\..\Banxico.CLABE\internal\functions"),
	
	[string]
	$ModuleName = "Banxico.CLABE",
...
$CommandPath = @(
    "$global:testroot\..\Banxico.CLABE\functions"
    "$global:testroot\..\Banxico.CLABE\internal\functions"
)
