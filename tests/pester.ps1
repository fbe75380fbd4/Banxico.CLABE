...
Remove-Module Banxico.CLABE -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\Banxico.CLABE\Banxico.CLABE.psd1"
Import-Module "$PSScriptRoot\..\Banxico.CLABE\Banxico.CLABE.psm1" -Force
